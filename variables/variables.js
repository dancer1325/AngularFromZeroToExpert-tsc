...
(function () {
    ...
    var mensajeLet = "mensajeLet 1";
    //let mensajeLet = "mensajeLet 1"; // let can not be redefined
    var MENSAJECONST = "mensajeConst";
    // mensajeConst = 'mensajeConst2'; // const not possible to redefine
    var number = 123; // If the tpe isn't specified --> The type is inferred
    ...
    var anything; // Several types can be specified for a variable
    ...
    if (true) {
        var mensaje = "Hola3";
        var mensajeLet_1 = "mensajeLet 2";
        console.log(mensaje);
        console.log(mensajeLet_1); // Specific of the scope
    }
